                ...
                <div class="data__fields form__divided">
                    <div class="data__left__side"> 
                        <div class="container__form__image"> 
                            <img
                            src="<?php echo W_IMAGES;?>/<?php echo $student['image']; ?>"
                        ...
                        <div class="fields__end">
                            ...
                            <div class="fields">
                                ...
                                <select id="studentLevel" name="studentLevel">
                                    <?php for ($i=1; $i<=10; $i++){ ?>
                                        <option <?php  echo ($student['level']==$i)?"selected ":""; ?> value="<?php echo $i ?>">Level <?php echo $i ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="data__right__side">
                        ...
                        <div class="fields__divided">
                            ...
                            <div class="fields">
                                ...
                                <input  type="date" name="studentDateOfBirth" id="studentDateOfBirth" value="<?php echo $student['dateOfBirth']; ?>"/>
                            </div>
                        </div>
                        ...
                        <div class="fields">
                            ...
                            <input type="email" name="studentEmail" id="studentEmail"  value="<?php echo $student['email']; ?>"/>
                        </div>
                    </div>
